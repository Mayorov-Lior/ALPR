...
def isSameChar(c1,c2): # recieves 2 boxes and returns whether they describe the same character
  x1, y1, w1, h1 = c1
  x2, y2, w2, h2 = c2
  interArea = (min(x2+w2, x1+w1) - max(x1,x2)) * (min(y2+h2, y1+h1) - max(y1,y2))
  boxArea1 = w1 * h1
  boxArea2 = w2 * h2
